public class Billetera {
    ...
    public Billetera(String dueño, double saldo) {
        this.dueño = dueño;
        this.saldo = saldo;
        System.out.println("Se ha creado la billetera de " + this.dueño + " con un saldo inicial de " + this.saldo);
    }
    ...
    public void retirardinero (double monto) {
        this.saldo -= monto;
        System.out.println("Se ha retirado " + monto + " de la billetera de " + this.dueño);
        mostrarsaldo();
    }
